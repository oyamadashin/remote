...
* 皆川氏は、衣服をただの「商品」ではなく、「友」として表現していることに注意してください
  * これはあくまで例です。必ずしもこうした関係性が正解ということではありません
...
* 出品者役の人が実際に持っている（持っていた）なかなか捨てられない衣服
  ...
  * ただし、架空の設定が多すぎると、あとで受け手グループの物語を評価するときに困るので、必要最小限に抑えてください
...
* 出品者には前もって、物語を作成する課題を割り当てます
  * 1月17日時点で出品者の物語が無いとゲームが開始できないからです
* ゲームマニュアルをゲーム開始の1週間以上前までに送ります
  * マニュアルには物語を作成するための手順も詳細にまとめられています


![bg h:500 right](pictures/ゲーミング手順.png)


---
## その他の補足
### 物語をつくるなんて難しそう……
* ゲームマニュアルに物語作成のためのフォーマットもつけて送ります
